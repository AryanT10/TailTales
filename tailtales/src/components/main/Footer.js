      ...
      <div className="footer-content">
        ...
        <div className="footer-nav">
          ...
          <ul className="footer-links">
            ...
            <li>
              <a href="/our-story" onClick={(e) => handleNavigation(e, "/our-story")}>
                Our Story
              </a>
            </li>
            <li>
              <a href="/book-appointment" onClick={(e) => handleNavigation(e, "/book-appointment")}>
                Book Appointment
              </a>
            </li>
            <li>
              <a href="/check-appointment" onClick={(e) => handleNavigation(e, "/check-appointment")}>
                Check Appointment
              </a>
            </li>
            <li>
