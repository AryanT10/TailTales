    ...
    grooming: [
      {
        ...
        description: "Bath + haircut (test entry only)",
        duration: "30 minutes",
        petTypes: ["dogs"],
        price: "$25",
      },
    ...
    <div className="book-appointment-page">
      <div className="book-appointment-container">
        ...
        <p className="book-appointment-welcome">
          Welcome, {user?.displayName || "Guest"}! Schedule your pet's
        ...
        {!submitted ? (
          <form onSubmit={handleSubmit}>
            ...
            {currentStep === 1 && (
              <div className="appointment-form-section">
                ...
                {services[serviceType]?.length > 0 ? (
                  services[serviceType].map((service) => (
                    ...
                    >
                      <div className="service-option-details">
                        ...
                        <div className="service-option-duration">
                  ...
                  >
                    🚧 Services for {serviceType} coming soon...
                  </div>
                )}
            ...
            {currentStep === 2 && (
              <div className="appointment-form-section">
                  ...
                  <div className="pet-selection-section">
                    ...
                    <div className="pet-selection-list">
                      {userPets.map((pet) => (
                        ...
                        >
                          <div className="pet-avatar">{pet.type.charAt(0)}</div>
                ...
                {petType &&
                  selectedService &&
                  !isServiceCompatible(selectedService) && (
                    <div
                      style={{
                        color: "#ff6b6b",
                        padding: "10px",
                    ...
                    >
                      ⚠️ The selected service is not available for {petType}.
                    ...
                    <div className="time-slots">
                      {availableTimeSlots.map((slot, index) => (
                        <div
                          key={`${slot.time}-${index}`}
                          className={`time-slot ${
                            appointmentTime === slot.time ? "selected" : ""
          ...
          <div className="appointment-form-section">
            ...
            <p style={{ marginTop: "20px", fontSize: "16px", color: "#555" }}>
              A confirmation email has been sent to {user?.email}. You can also
              view your appointment details in the{" "}
              <a
